              ...
              <div className="col-lg-6">
                ...
                <div className="product-thumbs">
                  <div className="product-thumbs-track">
                    <div className="pt" data-imgbigurl="img/product/1.jpg">
                      <img src={product[0].images[0]} />
                    </div>
                    <div className="pt" data-imgbigurl="img/product/2.jpg">
                      <img src={product[0].images[1]} />
                    </div>
                    <div className="pt" data-imgbigurl="img/product/3.jpg">
                      <img src={product[0].images[2]} />
                    </div>
                  </div>
                </div>
              </div>
